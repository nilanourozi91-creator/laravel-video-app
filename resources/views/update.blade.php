...
<body>
    ...
    <div class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-lg">
        ...
        <h1 class="text-3xl font-bold text-center mb-6 text-gray-500 h-fit">
            update video
        </h1>
        <form action="{{URL('video/edite', $video->id )}}" method="post" enctype="multipart/form-data"  class="space-y-4">
               @csrf
